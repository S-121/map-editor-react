...
const MapEditor: FC<MapEditorProps> = ({ product }) => {
  ...
  const MapView = useMemo(
    ...
    [lat, mapStyle, frame, width, height] // state that should refresh the map
  )
            ...
            <div className="md:mt-8 lg:mt-0 lg:col-start-1 lg:col-span-7 lg:row-start-1 lg:row-span-3">
              ...
              <div>
                <div className="art-collection">
                  <div className="art-frame overflow-hidden relative mx-auto" style={{width, height: height + 'px'}}>
                  ...
                  <Tab.Panel>
                    ...
                    <div className="mt-4 prose prose-sm max-w-none text-gray-500">
                      <ProductOptions
                        ...
                        getCurrentOption={(kind, label) => {
        
                          if (kind == 'orientation' && label == 'Horizontal') {
                            setWidth('500px');
                            setHeight(600);
                          }
                          if (kind == 'orientation' && label == 'Vertical') {
                            setWidth('100%');
                            setHeight(500);
                          }
                        }}
